...
class VFLTrainer(object):
    ...
    def model_eval(self):
        ...
        print(f'    VFL test loss avg: {sum(epoch_loss_list) / len(epoch_loss_list)}')
        print(f'    VFL history accuracy on test set: {self.test_acc_rate_list}')
        print(f'    VFL accuracy on test set: {(100 * correct / total):.2f}%')
